            ...
            <div className='pb-12'>
              ...
              <section className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                ...
                <p>
                  ...
                  group, it was quickly evident that their needs and
                  understanding of what the queue is, was very different. Since
                  the ordering team is broken down into a number of sub-teams,
                  sometimes very granular and specific roles had very unique
                  needs. <span>One thing became clear</span>, the functional
                  inconsistencies between each queue was creating confusion on
                  how users should interact with it, what functions it performed
                  and how to ultimately use it in the most efficient way.
                </p>
              </section>
              ...
              <section className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                ...
                <p>
                  ...
                  wild. At its core the queue is a data table no different from
                  an Excel document (without all the complex features). In fact
                  a lot of users would export data out of the site, and use
                  Excel to further filter the results. In an ideal situation we
                  can leverage and modify one of these existing frameworks but
                  due to technical limitations this was not possible.
                </p>
              </section>
                  ...
                  <div className='gap-8 md:grid md:grid-cols-3'>
                    ...
                    <div className='relative w-auto'>
                      ...
                      <p>
                        ...
                        challenge. Some functional features are common to all
                        data tables, some needed very custom solutions. A way to
                        solve this was to introduce overflow menus that can be
                        customized based on table and or based on orders within
                        a single table. The original design would expose the
                        actions on the page which made them hard to maintain and
                        wouldn't allow for a scalable solution
                      </p>
                    </div>
                    <div className='relative w-auto'>
                      {' '}
                      ...
                      <p>
                        One off the key observations and loudest set of feedback
                        from our users was that they wanted to maximize their
                        ability to view more data. The design introduced
                        mechanism for users to hide certain sections away from
                        view. An example of that was filters. Each queue had a
                        specific set of filters that varied in number, by
                        introducing a show/hide feature we were able to maximize
                        the screen for max efficiency
                      </p>
                    </div>
                  </div>
                </div>
