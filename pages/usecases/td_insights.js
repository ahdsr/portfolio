            ...
            <div className=''>
              <section className='bg-customblue'>
                <div className='px-8 mx-auto py-52 md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                  ...
                  <div className='summary'>
                    A suite of intelligent insights with personalized real-time
                    information that are relevant to customers' banking needs
                  </div>
                </div>
              </section>
              ...
              <section className='px-8 pb-12 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                ...
                <p>
                  ...
                  introduced new digital insights within the TD app designed to
                  prompt customers with guided self-serve options based on their
                  transaction history. These insights offer pro-active guidance
                  to help customers to intuitively complete an action without
                  having to search within the app or navigate to the external
                  site.
                </p>
              </section>
              ...
              <section className='pb-24 bg-white '>
                <div className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                  ...
                  <p>
                    Based on the response we got from our session, I designed a
                    ...
                    was at their destination. Tapping on the notification, the
                    user would be taken to a page where they could do their
                    calculation, a travel guide, as well as a budgeting tool.
                  </p>
              ...
              <section className='pb-24 inverse'>
                <div className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                  ...
                  <ul className='gap-8 font-light md:grid md:grid-cols-3 text-slate-300'>
                    ...
                    <li>
                      Confusion around exchange rates - "I generally understand
                      exchange rates, but I always worried about paying hidden
                      fees and charges."
                    </li>
                  </ul>
                </div>
