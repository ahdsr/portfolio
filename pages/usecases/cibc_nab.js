    ...
    <Layout>
      <div className='' id='square'>
          ...
          <section className='bg-black'>
            <div className='px-8 mx-auto py-52 md:px-16 lg:max-w-6xl xl:max-w-7xl'>
              ...
              <div className='summary'>
                ...
                tellus cras adipiscing enim eu turpis egestas. Tincidunt
        ...
        <section className='px-8 py-24 pb-12 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
          <h2>Overview</h2>
          <p>
            Our partners at VISA approached Live Labs (a innovation hub at CIBC)
            to solve an issue they were struggling with for some time. The issue
            at first glance was simple - customers when abroad were often opting
            to convert their CAN dollars into the currency of their travel
            destination when paying using POS merchant terminals. This resulted
            in a two fold loss - the customer paying more in fees, and CIBC
          ...
          >
            ...
            <div className='gap-8 md:grid md:grid-cols-2 fullbleed'>
              <div className='grid grid-cols-2 py-4 mb-8 font-light text-slate-700 '>
                ...
                <div></div>
                <div className='pt-2 font-medium text-right '>CAN $145.29 </div>
              </div>
              <div
              ...
              >
                ...
                <div></div>
                <div className='pt-2 font-medium text-right '>$ 142.50 CAN</div>
              </div>
            </div>
            ...
            <p>
              ...
              on this transaction and at the same time, the bank is missing out
              on{' '}
              <span className='p-2 pt-2 font-medium text-right bg-red-100'>
                $3.46
              </span>{' '}
            ...
            <p>
              ...
              vacation based on some average spending habits, you can quickly be
              short changed around $120-180 in extra fees. Without getting into
              detailed math its evident that the bank was the biggest looser in
              the equation.
            </p>
        ...
        <section className='py-24 inverse' id='sectionC'>
          <div className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
            ...
            <ul className='gap-8 py-12 font-light md:grid md:grid-cols-3 text-slate-300 content'>
              <li>
                Clients were keen and interested in what to do and see while at
                their destination
              </li>
              <li>
                They expressed a need for budgeting their trip - "It's very easy
                to loose track of their money while abroad."
              </li>
              <li>
        ...
        <section className='py-24 bg-white '>
          <div className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl '>
            ...
            <p>
              Based on the response we got from our session, I design a few low
              fidelity concepts of what the experience may look like. At a high
              level the flow was initiated by a push notification with CIBC
              recognizing the fact that the client was at their destination.
              Once tapping on the notification, the user would be prompted to
              sign-in allowing them to choose from a simple currency conversion
              calculator, a travel guide, as well as a budgeting tool.
            </p>
          ...
          <div className='px-8 mx-auto my-8 md:px-16 lg:max-w-6xl xl:max-w-7xl'>
            <div className=''>
              ...
              <p>
                ...
                customer ignored their push notification, or had them completely
                disabled as part of their phone settings they would never know
              ...
              <p>
                ...
                geographical location simply demanded it. CIBC on the other hand
                did not - we distilled our key problem statement.
              </p>
            ...
            <div className='gap-4 lg:grid lg:grid-cols-3'>
              <p className='p-8 border border-gray-400 border-dashed'>
                ...
                foreign country or an eCommerce website that is not domiciled in
                my home currency.
              </p>
              <p className='p-8 border border-gray-400 border-dashed'>
                <span>When</span> I am about to make a payment.
