            ...
            <div className=''>
              ...
              <section className='px-8 py-24 pb-12 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                ...
                <p>
                  ...
                  CIBC) to solve an issue they were struggling with for some
                  time. The issue at first glance was simple - customers when
                  abroad were often opting to convert their CAN dollars into the
                  currency of their travel destination when paying using POS
                  merchant terminals. This resulted in a two fold loss - the
                  customer paying more in fees, and CIBC loosing out on revenue.
                </p>
              </section>
              ...
              <section className='py-24'>
                <div className='px-8 py-4 mx-auto my-8 md:px-16 lg:max-w-6xl xl:max-w-7xl '>
                  ...
                  <p className='py-4'>
                    They are handed the POS and it shows something similar to
                    this. Not all POS systems are made equally, so this
                  ...
                  <p>
                    The numbers seems fairly small and insignificant at first
                    glance but they can start to add up. We discovered that on a
                    two week vacation based on some average spending habits, you
                    can quickly be short changed around $120-180 in extra fees.
                    Without getting into detailed math its evident that the bank
                    was the biggest looser in the equation.
                  </p>
              ...
              <section className='py-24 inverse'>
                <div className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                  ...
                  <p>
                    ...
                    was any other opportunities we were missing out on to serve
                    our customers in a more complete way, aside from the main
                    business problem.
                  </p>
                  <Masonry
                  ...
                  <ul className='gap-8 py-12 font-light md:grid md:grid-cols-3 text-slate-300 content'>
                    ...
                    <li>
                      ...
                      very easy to loose track of their money while abroad."
                    </li>
                    <li>
                      Foreign exchange rates were confusing to them - "I
                      generally understand exchange rates, but I always worried
                      about paying hidden fees and charges."
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section className='py-24 bg-white '>
                <div className='px-8 mx-auto md:px-16 lg:max-w-6xl xl:max-w-7xl '>
                  ...
                  <p>
                    Based on the response we got from our session, I design a
                    few low fidelity concepts of what the experience may look
                    like. At a high level the flow was initiated by a push
                    notification with CIBC recognizing the fact that the client
                    was at their destination. Once tapping on the notification,
                    the user would be prompted to sign-in allowing them to
                    choose from a simple currency conversion calculator, a
                    travel guide, as well as a budgeting tool.
                  </p>
              ...
              <section className='py-24'>
                <div className='px-8 mx-auto my-8 md:px-16 lg:max-w-6xl xl:max-w-7xl'>
                  <div className=''>
                    ...
                    <p>
                      We learned that it would be impossible to know to trigger
                      a notification at the time of a purchase. This meant that
                      if the customer ignored their push notification, or had
                      them completely disabled as part of their phone settings
                      they would never know we were offering them this service.
                    </p>
                    <p>
                      After the first day of the collaboration workshop in San
                      Francisco we discovered a few key differences between our
                      and NAB's capability for delivering a full travel
                      experience solution. NAB being situated in Australia,
                      already had a more comprehensive support framework for
                      travel tools. Their geographical location simply demanded
                      it. CIBC on the other hand did not - we distilled our key
                      problem statement.
                    </p>
                    <p className='mb-16 text-2xl font-light leading-loose text-green-700 callout fullbleed'>
                      <span className=''>As a client</span> paying a bill in
                      foreign currency (physical store or website), I want to{' '}
                      <span>
                        determine whether I should pay in the foreign currency
                        or a pre-converted amount in my home currency,
                      </span>{' '}
                      so that I can{' '}
