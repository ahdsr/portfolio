              ...
              <div className='px-5 mx-auto space-y-4 text-sm font-light leading-relaxed text-slate-300'>
                ...
                <div className='pt-6'>
                  <div className='flex items-center mt-8 mb-6'>
                    ...
                    <div className='ml-6'>
                      ...
                      <div className='jobrole'>User Experience Consultant</div>
                ...
                <div className='pt-6'>
                  ...
                  <ul className='pl-2 pr-2 ml-16'>
                    ...
                    <li>
                      Redesigning TD for Me experience from ground up using push
                      and location service technology allowing customers to
                      always be informed on what TD has to offer based on their
                      location
                    </li>
                    <li>
                ...
                <div className='pt-6'>
                  ...
                  <ul className='pl-2 pr-2 ml-16'>
                    ...
                    <li>
                      Redesigned Johnson Insurance online quoting an application
                      tool
                    </li>
                    <li>
                ...
                <div className='pt-6'>
                  ...
                  <ul className='pl-2 pr-2 ml-16'>
                    <li>
                      Inspire and lead a team of talented UX/Visual designers in
                      an environment that focuses on innovation
                    </li>
                    <li>
                    ...
                    <li>
                      Work with business / marketing in the creation of a vision
                      for user experience within the overall business strategy
                    </li>
                    <li>
                      Engage with and contribute to a project team made up of
                      Business, Development, Editorial and Analyst specialists,
                      as well as third parties and stakeholders
                    </li>
                    <li>
                ...
                <div className='pt-6'>
                  <div className='flex items-center mt-8 mb-6'>
                    ...
                    <div className='ml-6'>
                      ...
                      <div className='client'> Lead Creative / UX Designer</div>
                    </div>
                  </div>
                  ...
                  <ul className='pl-2 pr-2 ml-16'>
                    ...
                    <li>
                      Worked with Marketing/Strategy teams to create compelling
                      and effective designs on many aggressive sales
                      Multivariate Testing initiatives across CIBC.com
                      properties
                    </li>
                    <li>
                      Lead the visual design for a responsive design solution
                      for two major sales initiatives that included application
                      forms and mobile targeted offers.
                    </li>
                    <li>
                ...
                <div className='pt-6'>
                  <div className='flex items-center mt-8 mb-6'>
                    ...
                    <div className='ml-6 '>
                      ...
                      <div className='jobrole'>Senior Interactive Designer</div>
                  ...
                  <ul className='pl-2 pr-2 ml-16'>
                    <li>
                      Conception and development of interface design, animation,
                      micro websites and online rich media campaigns
                    </li>
                    <li>
                      Collaborated with marketing, strategists, content writers,
                      and IA/IX team members, and developers
                    </li>
                    <li>
                    ...
                    <li>
                      Proactively identified and solved potential issues within
                      assigned projects including creative that may impact
                      deliverables or the quality of the work
                    </li>
