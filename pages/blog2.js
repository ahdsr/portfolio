        ...
        <m.div initial='initial' animate='enter' exit='exit'>
          <m.main variants={fade} className='py-24 bg-white'>
            <VideoPost
              ...
              p2='Brushing back up on some After Effects skills. Testing out the blog post with embedded video content from Youtube.'
              p3='Brushing back up on some After Effects skills. Testing out the blog post with embedded video content from Youtube.'
              controls={true}
            />
            ...
            <ImagePost
              ...
              p2="Since I started to develop, I'm discovering a lot of new and useful tools. One of them being Sizzy. This app lets you preview your project on a bunch of different devices all at the same time."
              p3="Since I started to develop, I'm discovering a lot of new and useful tools. One of them being Sizzy. This app lets you preview your project on a bunch of different devices all at the same time."
            />
